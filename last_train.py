...
def train(args):
    ...
    # cfg.data.train.pipeline[2]["img_scale"] = args.train_resize  # Single Scale
    ...
    # cfg.data.test.pipeline[1]["img_scale"] = args.test_resize  # Single Scale
    ...
    train_detector(model, datasets, cfg, distributed=False, validate=False, meta=dict())
        ...
        with open(filename, "r") as f:
            for line in f:
                ...
                try:
                    ...
                    print(f"Error: {e}")
                    exit(1)
        self.data["train_ann_file_name"] = "train.json"
        self.data["classes"] = (
            "General trash",
            "Paper",
            "Paper pack",
