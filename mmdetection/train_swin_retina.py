...
def train(config):
    ...
    pretrained_retina = '/opt/ml/level2_objectdetection-cv-01/mmdetection/work_dirs/swin_retina/retinanet_r50_fpn_mstrain_3x_coco_20210718_220633-88476508.pth'
    cfg.model.bbox_head.init_cfg=dict(type='Pretrained',checkpoint=pretrained_retina)
